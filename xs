...
library.theme = {
    ...
    accentcolor = Color3.fromRGB(104, 143, 202),
    accentcolor2 = Color3.fromRGB(85, 129, 195),
    outlinecolor = Color3.fromRGB(25, 25, 25),
    outlinecolor2 = Color3.fromRGB(25, 25, 25),
    sectorcolor = Color3.fromRGB(29, 29, 29),
    toptextcolor = Color3.fromRGB(255, 255, 255),
    topheight = 48,
    topcolor = Color3.fromRGB(15, 15, 15),
    topcolor2 = Color3.fromRGB(13, 13, 13),
